  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900 border-gray-300  text-[12px] gap-10 rounded-md border-2 w-32 items-center text-center gap-10">
             +  1 -
          </span>
          <button className="flex ml-auto text-black  border-2 border-black py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
            Add to Cart
          </button>
